<template>
  <div>
    <div class="search">
      <el-input placeholder="请输入用户查询" style="width: 200px" v-model="userName"></el-input>
    ...
    <div class="table">
      <el-table :data="tableData" stripe @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="rootId" label="根id"></el-table-column>
    ...
    <el-dialog content="信息" :visible.sync="fromVisible" width="40%" :close-on-click-modal="false" destroy-on-close>
