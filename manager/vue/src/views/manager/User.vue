<template>
  <div>
    <div class="search">
      <el-input placeholder="请输入昵称查询" style="width: 200px" v-model="name"></el-input>
    ...
    <el-dialog title="用户信息" :visible.sync="fromVisible" width="40%" :close-on-click-modal="false" destroy-on-close>
      <el-form :model="form" label-width="100px" style="padding-right: 50px" :rules="rules" ref="formRef">
        ...
        <el-form-item label="介绍" prop="info">
          <el-input type="textarea" v-model="form.email" placeholder="邮箱"></el-input>
        </el-form-item>
        <el-form-item label="生日" prop="birth">
          <el-date-picker format="yyyy-MM-dd" value-format="yyyy-MM-dd" v-model="form.birth"
            style="width: 100%">
          </el-date-picker>
        </el-form-item>
